# expo-beacon full reference

For new integrations, start with the focused [getting-started guide](getting-started.md)
or use the [documentation index](index.md). This page retains the detailed
compatibility reference for the positional native API.
